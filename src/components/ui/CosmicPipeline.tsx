...
export default function CosmicPipeline() {
  ...
  useEffect(() => {
    const calculateCoordinates = () => {
      ...
      setPaths({
        ...
        // Distribution flows from the Mind/Psychic hub into Guna vectors
    ...
    // Calculate layout metrics with minor delay for layout stability
  ...
  return (
    ...
    >
      ...
      {/* STAGE 1: ULTIMATE SOURCE AXIS */}
      <div className="flex justify-between items-center w-full max-w-3xl mx-auto relative z-10 mb-20">
        {/* Tattva 1 */}
        <div className="pipeline-node group relative w-32 h-32 md:w-36 md:h-36 rounded-full border border-yellow-500/20 bg-yellow-500/5 backdrop-blur-sm flex flex-col items-center justify-center p-4 text-center transition-all duration-300 hover:border-yellow-500/40 hover:bg-yellow-500/10">
        ...
        {/* Tattva 2 */}
        <div className="pipeline-node group relative w-32 h-32 md:w-36 md:h-36 rounded-full border border-cyan-500/20 bg-cyan-500/5 backdrop-blur-sm flex flex-col items-center justify-center p-4 text-center transition-all duration-300 hover:border-cyan-500/40 hover:bg-cyan-500/10">
      ...
      <div className="flex flex-col items-center justify-center my-16 relative z-10">
        {/* Tattva 3 */}
        <div className="pipeline-node group relative w-40 h-20 md:w-44 md:h-24 bg-purple-950/10 border border-purple-500/20 rounded-[50%_50%_50%_50%_/_40%_40%_60%_60%] flex flex-col items-center justify-center p-4 text-center transition-all duration-300 hover:border-purple-500/40 hover:bg-purple-950/20">
          <span
            ref={anchors.mahadIn}
      ...
      {/* STAGE 3: AHAMKARA (THE SELF EGO INFRASTRUCTURE) */}
      <div className="flex flex-col items-center justify-center my-16 relative z-10">
        {/* Tattva 4 */}
        <div className="pipeline-node group relative w-20 h-20 md:w-24 md:h-24 bg-sky-950/10 border border-sky-400/20 rounded-[00%_00%_100%_100%] flex flex-col items-center justify-center transition-all duration-300 hover:border-sky-400/40 hover:bg-sky-950/20">
          <span
      ...
      <div className="flex flex-col items-center justify-center mb-20 relative z-10">
        {/* Tattva 5 */}
        <div className="pipeline-node group relative w-48 h-12 bg-neutral-950/80 border border-purple-500/30 rounded-sm flex flex-col items-center justify-center p-2 text-center transition-all duration-300 hover:border-purple-500/50">
          <span
            ref={anchors.manasIn}
      ...
      {/* STAGE 5: GUNA CHANNELS & THE 15 FLUID OUTCOME TATTVAS */}
      <div className="grid grid-cols-3 gap-3 md:gap-6 w-full relative z-10 items-start">
        {/* SATTVA EXPANSION (SENSORY MATRIX) */}
        <div className="flex flex-col items-center space-y-6">
          <div className="pipeline-node relative w-30 h-30 md:w-24 md:h-24 bg-blue-950/10 border border-blue-500/20 rounded-[50%_50%_50%_50%_/_70%_70%_40%_40%] flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-blue-500/40">
            <span
          ...
          <div className="w-full space-y-1.5">
            ...
            {[
              ...
              <div
                key={i}
                className="pipeline-node text-[9px] md:text-[10px] bg-neutral-950/70 border border-neutral-900 px-2 py-1.5 text-neutral-400 rounded-sm hover:border-blue-500/30 transition-all duration-200 hover:text-blue-200"
              >
        ...
        {/* RAJAS EXPANSION (DYNAMISM TOOLS) */}
        <div className="flex flex-col items-center space-y-6">
          <div className="pipeline-node relative w-26 h-26 md:w-20 md:h-20 bg-red-950/10 border border-red-500/20 rounded-xl flex flex-col items-center justify-center text-center rotate-45 transition-all duration-300 hover:border-red-500/40">
            <span
              ref={anchors.rajasIn}
              className="absolute top-0 left-1/2 w-1 h-1 opacity-0"
            />
          ...
          <div className="w-full space-y-1.5 pt-2">
            ...
            {[
              ...
              <div
                key={i}
                className="pipeline-node text-[9px] md:text-[10px] bg-neutral-950/70 border border-neutral-900 px-2 py-1.5 text-neutral-400 rounded-sm hover:border-red-500/30 transition-all duration-200 hover:text-red-200"
              >
        ...
        {/* TAMAS EXPANSION (ELEMENT MATERIAL CRADLE) */}
        <div className="flex flex-col items-center space-y-6">
          <div className="pipeline-node relative w-28 h-20 md:w-24 md:h-24 bg-neutral-900/60 border border-neutral-700/40 rounded-full flex flex-col items-center justify-center text-center transition-all duration-300 hover:border-neutral-500">
            <span
              ref={anchors.tamasIn}
              className="absolute top-0 left-1/2 w-1 h-1 opacity-0"
            />
          ...
          {/* Tattvas 16-25: 5 Tanmatras transitioning into 5 Mahabhutas */}
          <div className="w-full space-y-1.5">
            ...
            {[
              ...
              <div
                key={i}
                className="pipeline-node text-[9px] md:text-[10px] bg-neutral-950/70 border border-neutral-900 px-2 py-1.5 text-neutral-400 rounded-sm leading-tight hover:border-neutral-500 transition-all duration-200 hover:text-neutral-200"
              >
